...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_id', type=str, default='wikipeople_28_9', help='model id')
    parser.add_argument('--model', type=str, default='AutoARIMA',
                        help='model name, options: [Random, Arima]')

    # data loader
    parser.add_argument('--data', type=str, default='wiki', help='dataset type')
    parser.add_argument('--root_path', type=str, default='/home/xz/big/code/HTSFB_project/HTSFB_datasets/self/Wiki/', help='root path of the data file')
    parser.add_argument('--data_path', type=str, default='train_1_people_sampled.csv', help='data file')
    ...
    #
    parser.add_argument('--distribution', type=str, default='', help='[Uniform, Normal, Gaussian]')
    parser.add_argument('--season', type=int, default=7, help='the seasonality of the data')
    parser.add_argument('--constant', type=str, default='mean', help='should be mean or number, the constant of the data')
