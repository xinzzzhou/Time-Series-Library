...
if __name__ == '__main__':
    ...
    # data loader
    parser.add_argument('--data', type=str, default='traffic-re-re', help='dataset type')
    parser.add_argument('--root_path', type=str, default='/home/xinz/ar57_scratch/xinz/HTSFB_project/HTSFB_datasets/self/traffic/', help='root path of the data file')
    parser.add_argument('--data_path', type=str, default='traffic.csv', help='data file')
    parser.add_argument('--data_topk_path', type=str, default='/home/xinz/ar57_scratch/xinz/HTSFB_project/HTSFB_datasets/self/traffic/top-k/matrix_rank_traffic1.npy', help='data topk file')
