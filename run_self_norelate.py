...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Relateformer')
    ...
    parser.add_argument('--model', type=str, default='Relateformer', help='model name, options: [Autoformer, Transformer, TimesNet]')

    # data loader
    parser.add_argument('--data', type=str, default='crime-re-no', help='dataset type')
