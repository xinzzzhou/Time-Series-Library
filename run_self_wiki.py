...
if __name__ == '__main__':
    ...
    # data loader
    parser.add_argument('--data', type=str, default='wiki-re-s', help='dataset type')
    ...
    parser.add_argument('--data_topk_path', type=str, default='/home/xinz/ar57_scratch/xinz/HTSFB_project/HTSFB_datasets/self/Wiki/top-k/matrix_rank_wiki1.npy', help='data topk file')
    ...
    # forecasting task
    parser.add_argument('--k', type=int, default=2, help='number of nearest neighbors')
    ...
    # model define
    parser.add_argument('--patch_len', type=int, default=14, help='length of patch')
    parser.add_argument('--patch_stride', type=int, default=7, help='stride of patch')
    parser.add_argument('--top_k', type=int, default=5, help='for TimesBlock')
    parser.add_argument('--num_kernels', type=int, default=6, help='for Inception')
    parser.add_argument('--enc_in', type=int, default=6107, help='encoder input size')
