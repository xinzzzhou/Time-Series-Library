...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='RelateformerRouter')
    ...
    parser.add_argument('--model', type=str, default='RelateformerRouter', help='model name, options: [Autoformer, Transformer, TimesNet]')

    # data loader
    parser.add_argument('--data', type=str, default='crime-re-re', help='dataset type')
    parser.add_argument('--root_path', type=str, default='/home/xinz/ar57_scratch/xinz/HTSFB_project/HTSFB_datasets/self/CrimeChicago/region/', help='root path of the data file')
    parser.add_argument('--data_path', type=str, default='Crimes-2001_2023.csv', help='data file')
    parser.add_argument('--data_topk_path', type=str, default='/home/xinz/ar57_scratch/xinz/HTSFB_project/HTSFB_datasets/self/CrimeChicago/region/top-k/matrix_rank_crime.npy', help='data topk file')
    # parser.add_argument('--data_topk_path', type=str, default='/home/xinz/ar57_scratch/xinz/HTSFB_project/HTSFB_datasets/self/CrimeChicago/region/top-k/old_paired_top2.txt', help='data topk file')
 
    parser.add_argument('--output_path', type=str, default='/home/xinz/ar57_scratch/xinz/HTSFB_project/HTSFB_output/', help='output path')
    ...
    parser.add_argument('--checkpoints', type=str, default='/home/xinz/ar57_scratch/xinz/HTSFB_project/HTSFB_output/checkpoints/', help='location of model checkpoints')
    ...
    parser.add_argument('--seasonality', type=int, default=6, help='seasonality')
